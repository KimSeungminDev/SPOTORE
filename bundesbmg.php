...
// 데이터베이스에서 항목 가져오기
$result = db_select("SELECT * FROM contents WHERE content_code LIKE '%-1306%' $orderPhrase LIMIT $start, $itemsPerPage");

// 페이지 링크를 만들기 위한 전체 항목 개수 계산
$totalItems = db_select("SELECT COUNT(*) as count FROM contents WHERE content_code LIKE '%-1306%'")[0]['count'];
...
<body>
    ...
    <div class="picked_category">
        <span class="category_index">보루시아 묀헨글라트바흐 상품</span>
        <div><br></div>
        <div><br></div>
        <div class="soccer">
            <ul>
    ...
    <div class="pl">
        <div class="soccer_pl">
            <ul><li><a href="bundessvd.php">
                        <div class="selectlbtn">
                            <img src="./img/leauge/bundessvd.png" title="" class="js-smart-img">
                        </div>
            </a></li></ul>
            <!-- 다른 카테고리 항목들... -->
            <ul><li><a href="bundesbvb.php">
                        <div class="selectlbtn">
                            <img src="./img/leauge/bundesbvb.png" title="" class="js-smart-img">
                        </div>
            </a></li></ul>
            <ul><li><a href="bundesrbl.php">
                        <div class="selectlbtn">
                            <img src="./img/leauge/bundesrbl.png" title="" class="js-smart-img">
                        </div>
            </a></li></ul>
            <!-- 다른 카테고리 항목들... -->
            <ul><li><a href="bundesb04.php">
                        <div class="selectlbtn">
                            <img src="./img/leauge/bundesb04.png" title="" class="js-smart-img">
                        </div>
            </a></li></ul>
            <!-- 다른 카테고리 항목들... -->
            <ul><li><a href="bundesm05.php">
                        <div class="selectlbtn">
                            <img src="./img/leauge/bundesm05.png" title="" class="js-smart-img">
                        </div>
            </a></li></ul>
            <!-- 다른 카테고리 항목들... -->
            <ul><li><a href="bundesbmg.php">
                        <div class="selectlbtn">
                            <img src="./img/leauge/bundesbmg.png" title="" class="js-smart-img">
                        </div>
            </a></li></ul>
            <!-- 다른 카테고리 항목들... -->
            <ul><li><a href="bundesfcb.php">
                        <div class="selectlbtn">
                            <img src="./img/leauge/bundesfcb.png" title="" class="js-smart-img">
                        </div>
            </a></li></ul>
        </div>
        <div class="soccer_pl">
            <!-- 다른 카테고리 항목들... -->
            <ul><li><a href="bundessvw.php">
                        <div class="selectlbtn">
                            <img src="./img/leauge/bundessvw.png" title="" class="js-smart-img">
                        </div>
            </a></li></ul>
            <!-- 다른 카테고리 항목들... -->
            <ul><li><a href="bundeswob.php">
                        <div class="selectlbtn">
                            <img src="./img/leauge/bundeswob.png" title="" class="js-smart-img">
                        </div>
            </a></li></ul>
            <!-- 다른 카테고리 항목들... -->
            <ul><li><a href="bundesvfb.php">
                        <div class="selectlbtn">
                            <img src="./img/leauge/bundesvfb.png" title="" class="js-smart-img">
                        </div>
            </a></li></ul>
            <!-- 다른 카테고리 항목들... -->
            <ul><li><a href="bundesfca.php">
                        <div class="selectlbtn">
                            <img src="./img/leauge/bundesfca.png" title="" class="js-smart-img">
                        </div>
            </a></li></ul>
            <!-- 다른 카테고리 항목들... -->
            <ul><li><a href="bundesfcu.php">
                        <div class="selectlbtn">
                            <img src="./img/leauge/bundesfcu.png" title="" class="js-smart-img">
                        </div>
            </a></li></ul>
            <!-- 다른 카테고리 항목들... -->
            <ul><li><a href="bundesscf.php">
                        <div class="selectlbtn">
                            <img src="./img/leauge/bundesscf.png" title="" class="js-smart-img">
                        </div>
            </a></li></ul>
            <!-- 다른 카테고리 항목들... -->
            <ul><li><a href="bundesfra.php">
                        <div class="selectlbtn">
                            <img src="./img/leauge/bundesfra.png" title="" class="js-smart-img">
                        </div>
            </a></li></ul>
        </div>
    </div>
    ...
    <main class="main_wrapper">
        <div class="recommend_main_wrapper">
            ...
            <script>
                ...
                SortNew.addEventListener('click', function() {
                    location.href = 'bundesbmg.php?sort=SUBSTRING(content_code,1,6)&dir=desc&btn=1'
                });
                //높은가격순으로 정렬
                SortHighPrice.addEventListener('click', function() {
                    location.href = 'bundesbmg.php?sort=content_price&dir=desc&btn=3'
                });
                //낮은가격순으로 정렬
                SortLowPrice.addEventListener('click', function() {
                    location.href = 'bundesbmg.php?sort=content_price&dir=asc&btn=4'
                });
                //가나다순으로 정렬
                SortKor.addEventListener('click', function() {
                    location.href = 'bundesbmg.php?sort=content_name&dir=asc&btn=2'
                });
            </script>
            <div><br></div>
            <div><br></div>
        ...
        <?php for ($i = 1; $i <= $totalPages; $i++) : ?>
            <a href="bundesbmg.php?sort=<?php echo $sort; ?>&dir=<?php echo $dir; ?>&btn=<?php echo $btn; ?>&page=<?php echo $i; ?>"
