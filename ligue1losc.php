...
// 데이터베이스에서 항목 가져오기
$result = db_select("SELECT * FROM contents WHERE content_code LIKE '%-1506%' $orderPhrase LIMIT $start, $itemsPerPage");

// 페이지 링크를 만들기 위한 전체 항목 개수 계산
$totalItems = db_select("SELECT COUNT(*) as count FROM contents WHERE content_code LIKE '%-1506%'")[0]['count'];
...
<body>
    ...
    <div class="picked_category">
        <span class="category_index">LOSC 릴 상품</span>
        <div><br></div>
        <div><br></div>
        <div class="soccer">
            <ul>
    ...
    <div class="pl">
        <div class="soccer_pl">
            <ul><li><a href="ligue1fcn.php">
                        <div class="selectlbtn">
                            <img src="./img/leauge/ligue1fcn.png" title="" class="js-smart-img">
                        </div>
            </a></li></ul>
            <!-- 다른 카테고리 항목들... -->
            <ul><li><a href="ligue1ogc.php">
                        <div class="selectlbtn">
                            <img src="./img/leauge/ligue1ogc.png" title="" class="js-smart-img">
                        </div>
            </a></li></ul>
            <ul><li><a href="ligue1rcl.php">
                        <div class="selectlbtn">
                            <img src="./img/leauge/ligue1rcl.png" title="" class="js-smart-img">
                        </div>
            </a></li></ul>
            <!-- 다른 카테고리 항목들... -->
            <ul><li><a href="ligue1fcl.php">
                        <div class="selectlbtn">
                            <img src="./img/leauge/ligue1fcl.png" title="" class="js-smart-img">
                        </div>
            </a></li></ul>
            <!-- 다른 카테고리 항목들... -->
            <ul><li><a href="ligue1ol.php">
                        <div class="selectlbtn">
                            <img src="./img/leauge/ligue1ol.png" title="" class="js-smart-img">
                        </div>
            </a></li></ul>
        </div>
        <div class="soccer_pl">
            <!-- 다른 카테고리 항목들... -->
            <ul><li><a href="ligue1losc.php">
                        <div class="selectlbtn">
                            <img src="./img/leauge/ligue1losc.png" title="" class="js-smart-img">
                        </div>
            </a></li></ul>
            <!-- 다른 카테고리 항목들... -->
            <ul><li><a href="ligue1om.php">
                        <div class="selectlbtn">
                            <img src="./img/leauge/ligue1om.png" title="" class="js-smart-img">
                        </div>
            </a></li></ul>
            <!-- 다른 카테고리 항목들... -->
            <ul><li><a href="ligue1asm.php">
                        <div class="selectlbtn">
                            <img src="./img/leauge/ligue1asm.png" title="" class="js-smart-img">
                        </div>
            </a></li></ul>
            <!-- 다른 카테고리 항목들... -->
            <ul><li><a href="ligue1sr.php">
                        <div class="selectlbtn">
                            <img src="./img/leauge/ligue1sr.png" title="" class="js-smart-img">
                        </div>
            </a></li></ul>
            <!-- 다른 카테고리 항목들... -->
            <ul><li><a href="ligue1psg.php">
                        <div class="selectlbtn">
                            <img src="./img/leauge/ligue1psg.png" title="" class="js-smart-img">
                        </div>
            </a></li></ul>
        </div>
    </div>
    ...
    <main class="main_wrapper">
        <div class="recommend_main_wrapper">
            ...
            <script>
                ...
                SortNew.addEventListener('click', function() {
                    location.href = 'ligue1losc.php?sort=SUBSTRING(content_code,1,6)&dir=desc&btn=1'
                });
                //높은가격순으로 정렬
                SortHighPrice.addEventListener('click', function() {
                    location.href = 'ligue1losc.php?sort=content_price&dir=desc&btn=3'
                });
                //낮은가격순으로 정렬
                SortLowPrice.addEventListener('click', function() {
                    location.href = 'ligue1losc.php?sort=content_price&dir=asc&btn=4'
                });
                //가나다순으로 정렬
                SortKor.addEventListener('click', function() {
                    location.href = 'ligue1losc.php?sort=content_name&dir=asc&btn=2'
                });
            </script>
            <div><br></div>
            <div><br></div>
        ...
        <?php for ($i = 1; $i <= $totalPages; $i++) : ?>
            <a href="ligue1losc.php?sort=<?php echo $sort; ?>&dir=<?php echo $dir; ?>&btn=<?php echo $btn; ?>&page=<?php echo $i; ?>"
