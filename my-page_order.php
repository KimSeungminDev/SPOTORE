    ...
    <main class="main_wrapper my-page">
        <section class="menus">
            ...
            <ul class="navs">
                ...
                <a href="my-page_order.php"><li class="nav" style="background-color: #FD9F28; width: 165px;"><span>주문배송</span></li></a>
        ...
        <section class="view">
            ...
            <section class="table pay">
                ...
                <?php foreach($result as $key1=>$value){
                    ?>
                    <?php $total_price=0;?>
                    <?php $review_code = $result[$key1]['order_id'];
                    ...
                    <tr class="order_info_header">
                        <td class="order_date"><span><?php echo $date ?></span></td>
