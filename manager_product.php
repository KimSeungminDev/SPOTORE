            ...
            <section class="contents">
                ...
                <section class="contents_header">
					...
					<form method="POST">
                        ...
                        <button type="submit" formaction="manager_product.php?" class="regist_product">검색</button>
                        <button type="submit" formaction="product_registration.php" class="regist_product">상품 등록</button>
                        <!-- 삭제버튼 지움 -->
						</form>
                ...
                <article class="scroller">
                    <form action="" method="POST">
                        ...
                        <?php foreach($result as $r){?>
						    ...
						    if(strpos($r['content_name'], $search) !== false){
                                ?>
                        <a href="product_view.php?content_code=<?php echo $r['content_code']; ?>">
                            <div class="table_row">
                                <div class="table_col class"><?php echo "$r[category_large]"?></div>
