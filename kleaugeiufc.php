...
// 데이터베이스에서 항목 가져오기
$result = db_select("SELECT * FROM contents WHERE content_code LIKE '%-1609%' $orderPhrase LIMIT $start, $itemsPerPage");

// 페이지 링크를 만들기 위한 전체 항목 개수 계산
$totalItems = db_select("SELECT COUNT(*) as count FROM contents WHERE content_code LIKE '%-1609%'")[0]['count'];
...
<body>
    ...
    <div class="picked_category">
        <span class="category_index">인천 유나이티드 FC 상품</span>
        <div><br></div>
        <div><br></div>
        <div class="soccer">
            <ul>
    ...
    <div class="pl">
        <div class="soccer_pl">
            <ul><li><a href="kleaugegwfc.php">
                        <div class="selectlbtn">
                            <img src="./img/leauge/kleaugegwfc.png" title="" class="js-smart-img">
                        </div>
            </a></li></ul>
            <ul><li><a href="kleaugegjfc.php">
                        <div class="selectlbtn">
                            <img src="./img/leauge/kleaugegjfc.png" title="" class="js-smart-img">
                        </div>
            </a></li></ul>
            <!-- 다른 카테고리 항목들... -->
            <ul><li><a href="kleaugedgfc.php">
                        <div class="selectlbtn">
                            <img src="./img/leauge/kleaugedgfc.png" title="" class="js-smart-img">
                        </div>
            </a></li></ul>
            <!-- 다른 카테고리 항목들... -->
            <ul><li><a href="kleaugedhfc.php">
                        <div class="selectlbtn">
                            <img src="./img/leauge/kleaugedhfc.png" title="" class="js-smart-img">
                        </div>
            </a></li></ul>
            <!-- 다른 카테고리 항목들... -->
            <ul><li><a href="kleaugefcs.php">
                        <div class="selectlbtn">
                            <img src="./img/leauge/kleaugefcs.png" title="" class="js-smart-img">
                        </div>
            </a></li></ul>
            <!-- 다른 카테고리 항목들... -->
            <ul><li><a href="kleaugessb.php">
                        <div class="selectlbtn">
                            <img src="./img/leauge/kleaugessb.png" title="" class="js-smart-img">
                        </div>
            </a></li></ul>
        </div>
        <div class="soccer_pl">
            <!-- 다른 카테고리 항목들... -->
            <ul><li><a href="kleaugesfc.php">
                        <div class="selectlbtn">
                            <img src="./img/leauge/kleaugesfc.png" title="" class="js-smart-img">
                        </div>
            </a></li></ul>
            <!-- 다른 카테고리 항목들... -->
            <ul><li><a href="kleaugeuhfc.php">
                        <div class="selectlbtn">
                            <img src="./img/leauge/kleaugeuhfc.png" title="" class="js-smart-img">
                        </div>
            </a></li></ul>
            <!-- 다른 카테고리 항목들... -->
            <ul><li><a href="kleaugeiufc.php">
                        <div class="selectlbtn">
                            <img src="./img/leauge/kleaugeiufc.png" title="" class="js-smart-img">
                        </div>
            </a></li></ul>
            <!-- 다른 카테고리 항목들... -->
            <ul><li><a href="kleaugejhm.php">
                        <div class="selectlbtn">
                            <img src="./img/leauge/kleaugejhm.png" title="" class="js-smart-img">
                        </div>
            </a></li></ul>
            <!-- 다른 카테고리 항목들... -->
            <ul><li><a href="kleaugejufc.php">
                        <div class="selectlbtn">
                            <img src="./img/leauge/kleaugejufc.png" title="" class="js-smart-img">
                        </div>
            </a></li></ul>
            <!-- 다른 카테고리 항목들... -->
            <ul><li><a href="kleaugephs.php">
                        <div class="selectlbtn">
                            <img src="./img/leauge/kleaugephs.png" title="" class="js-smart-img">
                        </div>
            </a></li></ul>
        </div>
    </div>
    ...
    <main class="main_wrapper">
        <div class="recommend_main_wrapper">
            ...
            <script>
                ...
                SortNew.addEventListener('click', function() {
                    location.href = 'kleaugeiufc.php?sort=SUBSTRING(content_code,1,6)&dir=desc&btn=1'
                });
                //높은가격순으로 정렬
                SortHighPrice.addEventListener('click', function() {
                    location.href = 'kleaugeiufc.php?sort=content_price&dir=desc&btn=3'
                });
                //낮은가격순으로 정렬
                SortLowPrice.addEventListener('click', function() {
                    location.href = 'kleaugeiufc.php?sort=content_price&dir=asc&btn=4'
                });
                //가나다순으로 정렬
                SortKor.addEventListener('click', function() {
                    location.href = 'kleaugeiufc.php?sort=content_name&dir=asc&btn=2'
                });
            </script>
            <div><br></div>
            <div><br></div>
        ...
        <?php for ($i = 1; $i <= $totalPages; $i++) : ?>
            <a href="kleaugeiufc.php?sort=<?php echo $sort; ?>&dir=<?php echo $dir; ?>&btn=<?php echo $btn; ?>&page=<?php echo $i; ?>"
