...
<body>
    ...
    <main class="cart_wrapper pay">
        <section class="pay_header">
            ...
            <!-- <p>장바구니에 상품을 추가했습니다.</p> -->
            <div class="back_buttons">
            <a href="cart.php"><button>< 장바구니 페이지</button>  </a>
            </div>
        </section>
        <section class="table">
            <table>
                        ...
                        <div class="deliv_address_wrapper">
                            ...
                            <div class="deliv_check"> 
                                ...
                                <div class="deliv_post_code">
                                    <input name="zip_code" type="text" class="deliv_text_post_code" id="postcode" placeholder="우편번호" />
                                    <div class="deliv_search_code">
                                        <button type="button" class="deliv_search_post_code" onclick=""> 우편번호 </button>
                                    </div>
                                </div>
                                <div class="deliv_road_name">
                                    <input name="address1" type="text" class="deliv_search_road_name" id="address" placeholder="주소" />
                                </div>
