...
// 데이터베이스에서 항목 가져오기
$result = db_select("SELECT * FROM contents WHERE content_code LIKE '%-41%' $orderPhrase LIMIT $start, $itemsPerPage");

// 페이지 링크를 만들기 위한 전체 항목 개수 계산
$totalItems = db_select("SELECT COUNT(*) as count FROM contents WHERE content_code LIKE '%-41%'")[0]['count'];
...
<body>
    ...
    <div class="picked_category">
        <span class="category_index">V-리그 남성부 상품</span>
        <div><br></div>
        <div><br></div>
        <div class="soccer">
            <ul>
    ...
    <div class="pl">
        <div class="soccer_pl">
            <ul><li><a href="vmikaj.php">
                        <div class="selectlbtn">
                            <img src="./img/tlogo/대한항공.jpg" title="" class="js-smart-img">
                        </div>
            </a></li></ul>
            <!-- 다른 카테고리 항목들... -->
            <ul><li><a href="vmukbs.php">
                        <div class="selectlbtn">
                            <img src="./img/tlogo/KB.jpg" title="" class="js-smart-img">
                        </div>
            </a></li></ul>
            <!-- 다른 카테고리 항목들... -->
            <ul><li><a href="vmskv.php">
                        <div class="selectlbtn">
                            <img src="./img/tlogo/한국전력.jpg" title="" class="js-smart-img">
                        </div>
            </a></li></ul>
            <!-- 다른 카테고리 항목들... -->
            <ul><li><a href="vmsww.php">
                        <div class="selectlbtn">
                            <img src="./img/tlogo/우리.jpg" title="" class="js-smart-img">
                        </div>
            </a></li></ul>
            <!-- 다른 카테고리 항목들... -->
            <ul><li><a href="vmaok.php">
                        <div class="selectlbtn">
                            <img src="./img/tlogo/OK금융.jpg" title="" class="js-smart-img">
                        </div>
            </a></li></ul>
            <!-- 다른 카테고리 항목들... -->
            <ul><li><a href="vmdsb.php">
                        <div class="selectlbtn">
                            <img src="./img/tlogo/삼성화재.jpg" title="" class="js-smart-img">
                        </div>
            </a></li></ul>
            <!-- 다른 카테고리 항목들... -->
            <ul><li><a href="vmchsw.php">
                        <div class="selectlbtn">
                            <img src="./img/tlogo/현대캐피탈.jpg" title="" class="js-smart-img">
                        </div>
            </a></li></ul>
        </div>
    </div>
    ...
    <main class="main_wrapper">
        <div class="recommend_main_wrapper">
            ...
            <script>
                ...
                SortNew.addEventListener('click', function() {
                    location.href = 'vleaugeman.php?sort=SUBSTRING(content_code,1,6)&dir=desc&btn=1'
                });
                //가나다순으로 정렬
                SortKor.addEventListener('click', function() {
                    location.href = 'vleaugeman.php?sort=content_name&dir=asc&btn=2'
                });
                //높은가격순으로 정렬
                SortHighPrice.addEventListener('click', function() {
                    location.href = 'vleaugeman.php?sort=content_price&dir=desc&btn=3'
                });
                //낮은가격순으로 정렬
                SortLowPrice.addEventListener('click', function() {
                    location.href = 'vleaugeman.php?sort=content_price&dir=asc&btn=4'
                });
            </script>
            <div><br></div>
            <div><br></div>
        ...
        <?php for ($i = 1; $i <= $totalPages; $i++) : ?>
            <a href="vleaugeman.php?sort=<?php echo $sort; ?>&dir=<?php echo $dir; ?>&btn=<?php echo $btn; ?>&page=<?php echo $i; ?>"
