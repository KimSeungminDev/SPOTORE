...
// 데이터베이스에서 항목 가져오기
$result = db_select("SELECT * FROM contents WHERE content_code LIKE '%-51%' $orderPhrase LIMIT $start, $itemsPerPage");

// 페이지 링크를 만들기 위한 전체 항목 개수 계산
$totalItems = db_select("SELECT COUNT(*) as count FROM contents WHERE content_code LIKE '%-51%'")[0]['count'];
...
<body>
    ...
    <div class="picked_category">
        <span class="category_index">League of Legends Champions Korea 상품</span>
        <div><br></div>
        <div><br></div>
        <div class="soccer">
            <ul>
                <li>
                    <a href="lck.php">
                        <div class="logobutton">
                            <img src="./img/tlogo/lck.jpg" title="" class="js-smart-img">
                        </div>
                    </a>
                </li>
            </ul>
            ...
            <ul>
                <li>
                    <a href="esportsnat.php">
                        <div class="logobutton">
                            <img src="./img/tlogo/koresports.jpg" title="" class="js-smart-img">
                        </div>
                    </a>
                </li>
            </ul>
    ...
    <div class="pl">
        <div class="soccer_pl">
            <ul><li><a href="lckgen.php">
                        <div class="selectlbtn">
                            <img src="./img/tlogo/젠지.png" title="" class="js-smart-img">
                        </div>
            </a></li></ul>
            <!-- 다른 카테고리 항목들... -->
            <ul><li><a href="lckt1.php">
                        <div class="selectlbtn">
                            <img src="./img/tlogo/T1.png" title="" class="js-smart-img">
                        </div>
            </a></li></ul>
            <!-- 다른 카테고리 항목들... -->
            <ul><li><a href="lckkt.php">
                        <div class="selectlbtn">
                            <img src="./img/tlogo/KT.png" title="" class="js-smart-img">
                        </div>
            </a></li></ul>
            <!-- 다른 카테고리 항목들... -->
            <ul><li><a href="lckhle.php">
                        <div class="selectlbtn">
                            <img src="./img/tlogo/HLE.png" title="" class="js-smart-img">
                        </div>
            </a></li></ul>
            <!-- 다른 카테고리 항목들... -->
            <ul><li><a href="lckdk.php">
                        <div class="selectlbtn">
                            <img src="./img/tlogo/Dplus.png" title="" class="js-smart-img">
                        </div>
            </a></li></ul>
        </div>
        <div class="soccer_pl">
            <!-- 다른 카테고리 항목들... -->
            <ul><li><a href="lckdrx.php">
                        <div class="selectlbtn">
                            <img src="./img/tlogo/drx.jpg" title="" class="js-smart-img">
                        </div>
            </a></li></ul>
            <!-- 다른 카테고리 항목들... -->
            <ul><li><a href="lcklsb.php">
                        <div class="selectlbtn">
                            <img src="./img/tlogo/리브샌박.png" title="" class="js-smart-img">
                        </div>
            </a></li></ul>
            <!-- 다른 카테고리 항목들... -->
            <ul><li><a href="lckbro.php">
                        <div class="selectlbtn">
                            <img src="./img/tlogo/OK브리온.jpg" title="" class="js-smart-img">
                        </div>
            </a></li></ul>
            <!-- 다른 카테고리 항목들... -->
            <ul><li><a href="lckns.php">
                        <div class="selectlbtn">
                            <img src="./img/tlogo/농심.jpg" title="" class="js-smart-img">
                        </div>
            </a></li></ul>
            <!-- 다른 카테고리 항목들... -->
            <ul><li><a href="lckkdf.php">
                        <div class="selectlbtn">
                            <img src="./img/tlogo/KDF.jpg" title="" class="js-smart-img">
                        </div>
            </a></li></ul>
        </div>
    </div>
    ...
    <main class="main_wrapper">
        <div class="recommend_main_wrapper">
            ...
            <script>
                ...
                SortNew.addEventListener('click', function() {
                    location.href = 'lck.php?sort=SUBSTRING(content_code,1,6)&dir=desc&btn=1'
                });
                //가나다순으로 정렬
                SortKor.addEventListener('click', function() {
                    location.href = 'lck.php?sort=content_name&dir=asc&btn=2'
                });
                //높은가격순으로 정렬
                SortHighPrice.addEventListener('click', function() {
                    location.href = 'lck.php?sort=content_price&dir=desc&btn=3'
                });
                //낮은가격순으로 정렬
                SortLowPrice.addEventListener('click', function() {
                    location.href = 'lck.php?sort=content_price&dir=asc&btn=4'
                });
            </script>
            <div><br></div>
            <div><br></div>
        ...
        <?php for ($i = 1; $i <= $totalPages; $i++) : ?>
            <a href="lck.php?sort=<?php echo $sort; ?>&dir=<?php echo $dir; ?>&btn=<?php echo $btn; ?>&page=<?php echo $i; ?>"
