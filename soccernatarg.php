...
// 데이터베이스에서 항목 가져오기
$result = db_select("SELECT * FROM contents WHERE content_code LIKE '%-1708%' $orderPhrase LIMIT $start, $itemsPerPage");

// 페이지 링크를 만들기 위한 전체 항목 개수 계산
$totalItems = db_select("SELECT COUNT(*) as count FROM contents WHERE content_code LIKE '%-1708%'")[0]['count'];
...
<body>
    ...
    <div class="picked_category">
        <span class="category_index">아르헨티나 축구 국가대표 상품</span>
        <div><br></div>
        <div><br></div>
        <div class="soccer">
            <ul>
    ...
    <div class="pl">
        <div class="soccer_pl">
            <ul><li><a href="soccernatned.php">
                        <div class="selectlbtn">
                            <img src="./img/leauge/soccernatned.png" title="" class="js-smart-img">
                        </div>
            </a></li></ul>
            <!-- 다른 카테고리 항목들... -->
            <ul><li><a href="soccernatmar.php">
                        <div class="selectlbtn">
                            <img src="./img/leauge/soccernatmar.png" title="" class="js-smart-img">
                        </div>
            </a></li></ul>
            <ul><li><a href="soccernatusa.php">
                        <div class="selectlbtn">
                            <img src="./img/leauge/soccernatusa.png" title="" class="js-smart-img">
                        </div>
            </a></li></ul>
            <!-- 다른 카테고리 항목들... -->
            <ul><li><a href="soccernatbra.php">
                        <div class="selectlbtn">
                            <img src="./img/leauge/soccernatbra.png" title="" class="js-smart-img">
                        </div>
            </a></li></ul>
            <!-- 다른 카테고리 항목들... -->
            <ul><li><a href="soccernatsen.php">
                        <div class="selectlbtn">
                            <img src="./img/leauge/soccernatsen.png" title="" class="js-smart-img">
                        </div>
            </a></li></ul>
            <!-- 다른 카테고리 항목들... -->
            <ul><li><a href="soccernatsui.php">
                        <div class="selectlbtn">
                            <img src="./img/leauge/soccernatsui.png" title="" class="js-smart-img">
                        </div>
            </a></li></ul>
            <!-- 다른 카테고리 항목들... -->
            <ul><li><a href="soccernatesp.php">
                        <div class="selectlbtn">
                            <img src="./img/leauge/soccernatesp.png" title="" class="js-smart-img">
                        </div>
            </a></li></ul>
            <!-- 다른 카테고리 항목들... -->
            <ul><li><a href="soccernatarg.php">
                        <div class="selectlbtn">
                            <img src="./img/leauge/soccernatarg.png" title="" class="js-smart-img">
                        </div>
            </a></li></ul>
        </div>
        <div class="soccer_pl">
            <!-- 다른 카테고리 항목들... -->
            <ul><li><a href="soccernateng.php">
                        <div class="selectlbtn">
                            <img src="./img/leauge/soccernateng.png" title="" class="js-smart-img">
                        </div>
            </a></li></ul>
            <!-- 다른 카테고리 항목들... -->
            <ul><li><a href="soccernatjpn.php">
                        <div class="selectlbtn">
                            <img src="./img/leauge/soccernatjpn.png" title="" class="js-smart-img">
                        </div>
            </a></li></ul>
            <!-- 다른 카테고리 항목들... -->
            <ul><li><a href="soccernatcro.php">
                        <div class="selectlbtn">
                            <img src="./img/leauge/soccernatcro.png" title="" class="js-smart-img">
                        </div>
            </a></li></ul>
            <!-- 다른 카테고리 항목들... -->
            <ul><li><a href="soccernatpor.php">
                        <div class="selectlbtn">
                            <img src="./img/leauge/soccernatpor.png" title="" class="js-smart-img">
                        </div>
            </a></li></ul>
            <!-- 다른 카테고리 항목들... -->
            <ul><li><a href="soccernatpol.php">
                        <div class="selectlbtn">
                            <img src="./img/leauge/soccernatpol.png" title="" class="js-smart-img">
                        </div>
            </a></li></ul>
            <!-- 다른 카테고리 항목들... -->
            <ul><li><a href="soccernatfra.php">
                        <div class="selectlbtn">
                            <img src="./img/leauge/soccernatfra.png" title="" class="js-smart-img">
                        </div>
            </a></li></ul>
            <!-- 다른 카테고리 항목들... -->
            <ul><li><a href="soccernatkor.php">
                        <div class="selectlbtn">
                            <img src="./img/leauge/soccernatkor.png" title="" class="js-smart-img">
                        </div>
            </a></li></ul>
            <!-- 다른 카테고리 항목들... -->
            <ul><li><a href="soccernataus.php">
                        <div class="selectlbtn">
                            <img src="./img/leauge/soccernataus.png" title="" class="js-smart-img">
                        </div>
            </a></li></ul>
        </div>
    </div>
    ...
    <main class="main_wrapper">
        <div class="recommend_main_wrapper">
            ...
            <script>
                ...
                SortNew.addEventListener('click', function() {
                    location.href = 'soccernatarg.php?sort=SUBSTRING(content_code,1,6)&dir=desc&btn=1'
                });
                //높은가격순으로 정렬
                SortHighPrice.addEventListener('click', function() {
                    location.href = 'soccernatarg.php?sort=content_price&dir=desc&btn=3'
                });
                //낮은가격순으로 정렬
                SortLowPrice.addEventListener('click', function() {
                    location.href = 'soccernatarg.php?sort=content_price&dir=asc&btn=4'
                });
                //가나다순으로 정렬
                SortKor.addEventListener('click', function() {
                    location.href = 'soccernatarg.php?sort=content_name&dir=asc&btn=2'
                });
            </script>
            <div><br></div>
            <div><br></div>
        ...
        <?php for ($i = 1; $i <= $totalPages; $i++) : ?>
            <a href="soccernatarg.php?sort=<?php echo $sort; ?>&dir=<?php echo $dir; ?>&btn=<?php echo $btn; ?>&page=<?php echo $i; ?>"
