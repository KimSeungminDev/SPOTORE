    ...
    <main class="manager_wrapper home">
        ...
        <div class="main_display">
            ...
            <section class="contents">
                ...
                <div class="table_col">이미지 링크: <?php echo $notice['imglink']; ?></div>
                <div class="table_col">페이지 링크: <?php echo $notice['pagelink']; ?></div>
                <div class="content-text-container">
                <div class="table_col content"> <?php echo $notice['content']; ?></div> <!-- 본문 -->
                </div>
            </div>
                <div class="button-container">
                <input type="button" value="수정" onclick="location.href='event_update.php?num=<?=$num?>'">
                <input type="button" value="삭제" onclick="location.href='event_delete.php?num=<?=$num?>'">
                </div>
            </section>
        </div>
    </main>
